...
`880a119466faebbf19ed05e39206ff4ba87237a2`. The committed
...
`/home/dev/rusty-engine-head/studio/dist/apps/studio-app/browser`, built from a
...
```sh
mkdir -p /home/dev/rusty-engine-head
git -C /home/dev/rusty-engine archive 880a119466faebbf19ed05e39206ff4ba87237a2 \
  | tar -x -C /home/dev/rusty-engine-head
cd /home/dev/rusty-engine-head/studio
...
node /home/dev/rusty-dagger/scripts/studio-static-provenance.mjs \
  /home/dev/rusty-engine-head/studio/dist/apps/studio-app/browser
```
