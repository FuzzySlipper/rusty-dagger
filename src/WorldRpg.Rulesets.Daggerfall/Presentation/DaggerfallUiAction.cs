...
internal sealed record DaggerfallPlayerUiAction(string Action, string? Revision = null, string? Item = null, int? TargetGrid = null, string? TargetEquipment = null);
...
internal static class DaggerfallUiAction
{
    internal static DaggerfallPlayerUiAction? Parse(ReadOnlySpan<byte> payload)
    {
        ...
        try
        {
            ...
            string? action = null, revision = null, item = null, targetEquipment = null;
            int? targetGrid = null;
