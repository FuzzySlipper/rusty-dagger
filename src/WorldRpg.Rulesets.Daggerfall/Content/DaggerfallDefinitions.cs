...
internal sealed record DaggerfallItemDefinition(string Id, ulong MaximumQuantity);
...
internal sealed class DaggerfallCatalog
{
    internal DaggerfallCatalog()
    {
        ...
        Player = new("player", playerStats, DaggerfallVitalValues.Player(playerStats), new(DaggerfallMechanicsIds.Health, DaggerfallMechanicsIds.Stamina), new(0));
        Rat = new("rat", new(40, 80, 0, 0, 50, 0, 35, 0), DaggerfallVitalValues.Fixed(16), new(DaggerfallMechanicsIds.Health, null), new(50));
        SkeletalWarrior = new("skeletal-warrior", new(50, 80, 0, 0, 50, 75, 75, 75), DaggerfallVitalValues.Fixed(66), new(DaggerfallMechanicsIds.Health, null), new(450, new("H", "gold-piece", 2, 10)));
        IronLongsword = new("iron-longsword", 2, 16, DaggerfallMechanicsIds.LongBlade.Value);
        Items = [new DaggerfallItemDefinition(IronLongsword.Id, 1), new("iron-dagger", 1), new("iron-cuirass", 1), new("gold-piece", 10_000)];
    ...
    internal IReadOnlyList<DaggerfallItemDefinition> Items { get; }
