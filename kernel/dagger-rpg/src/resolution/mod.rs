...
pub use eval::{
    ...
    apply_standard_mechanics_operation, definition_base_stats, equipped_weapon,
    ...
    ActorEquipment, ActorExprValues, DaggerDynamicRoll, DaggerStandardMechanicsError, ExprContext,
};
