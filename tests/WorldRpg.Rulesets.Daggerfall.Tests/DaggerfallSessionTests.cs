...
public sealed class DaggerfallSessionTests
{
    ...
    private static ProductContent ProductContentWithPlayer() => new(new ProductContentFile[] {
        new ProductContentFile(Encoding.UTF8.GetBytes("worldrpg/bundles/daggerfall.privateers-hold.bundle.json"), Encoding.UTF8.GetBytes("""{"kind":"worldrpg.game-bundle","id":"daggerfall.privateers-hold","version":1,"ruleset":"daggerfall","contentPacks":[{"id":"daggerfall.privateers-hold","version":1}],"tuning":{"id":"daggerfall.privateers-hold","version":1}}""")),
        new ProductContentFile(Encoding.UTF8.GetBytes("worldrpg/content-packs/daggerfall.privateers-hold.pack.json"), Encoding.UTF8.GetBytes("""{"kind":"worldrpg.content-pack","id":"daggerfall.privateers-hold","version":1,"dependencies":[],"payload":"worldrpg/payloads/daggerfall.privateers-hold.json"}""")),
